...
(function () {
  ...
  const Tooltip = {
    ...
    _onMouseOver(e) {
      ...
      const html = title ? `<strong>${title}</strong>${content}` : content;
      this._hideTimer = setTimeout(() => this.show(html, e.clientX, e.clientY), 150);
    },
  ...
  window.SnowflakeViz.Tooltip = Tooltip;
})();
