...
const FLAG = 'kafka_tour_done';

const STEPS = [
  { sel: '#sidebar',      title: 'Your module map', body: '22 lessons grouped by topic — Foundation, Core Internals, Consumer Side, Delivery, Ecosystem, Operations, and Advanced. Progress is tracked automatically.' },
  { sel: '.module-tabs',  title: 'Explore each topic', body: 'Every module has multiple tabs — animated diagrams, comparisons, configs, and interview Q&A. Click through them.' },
