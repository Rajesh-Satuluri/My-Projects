...
'.rel-body { display: grid; grid-template-columns: 190px 1fr; gap: 0; overflow: hidden; }',
...
'.rel-main { display: flex; flex-direction: column; overflow: hidden; }',
'.rel-diagram { flex: 1; overflow: hidden; display: flex; align-items: center; justify-content: center; padding: 12px; background: var(--bg-1); }',
'.rel-diagram svg { max-width: 100%; max-height: 100%; border-radius: 8px; }',
'.rel-info { border-top: 1px solid var(--border-default); padding: 12px 20px 14px; background: var(--bg-2); flex-shrink: 0; }',
...
'.rel-val { font-size: 12.5px; color: var(--text-secondary); line-height: 1.5; }',
'.rel-eg { font-family: var(--font-mono); color: var(--text-primary); font-size: 11px; }',
'.rel-sql { font-family: var(--font-mono); color: var(--green,#3fb950); font-size: 10.5px; white-space: pre; background: var(--bg-1); border: 1px solid var(--border-default); border-radius: 6px; padding: 8px 10px; overflow-x: auto; }',
'</style>',
