...
(function () {
  ...
  const NAV_GROUPS = [
    ...
    },
    {
      ...
      items: [
        { id: 'acid-transactions',  label: 'ACID Transactions',   icon: 'shield',      available: false },
        { id: 'time-travel',        label: 'Time Travel',         icon: 'clock',       available: false },
        { id: 'schema-evolution',   label: 'Schema Evolution',    icon: 'columns',     available: false },
        { id: 'data-skipping',      label: 'Data Skipping',       icon: 'filter',      available: false },
    ...
    },
    {
      ...
      label: 'Unity Catalog',
      items: [
        { id: 'uc-architecture',    label: 'UC Architecture',     icon: 'layers',      available: false },
        { id: 'metastore',          label: 'Metastore',           icon: 'database',    available: false },
        { id: 'catalog-schema',     label: 'Catalog & Schema',    icon: 'folder',      available: false },
        { id: 'lineage',            label: 'Data Lineage',        icon: 'git-branch',  available: false },
        { id: 'row-security',       label: 'Row-Level Security',  icon: 'lock',        available: false },
        { id: 'column-masking',     label: 'Column Masking',      icon: 'eye-off',     available: false },
        { id: 'delta-sharing',      label: 'Delta Sharing',       icon: 'share',       available: false },
        { id: 'audit-logs',         label: 'Audit Logs',          icon: 'file-text',   available: false },
      ],
    },
    {
      id: 'dlt-pipelines',
