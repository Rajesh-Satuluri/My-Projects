...
(function () {
  ...
  const NAV_GROUPS = [
    ...
    },
    {
      ...
      items: [
        { id: 'create-table',  label: 'CREATE TABLE',    icon: 'table-plus',  available: false },
        { id: 'insert',        label: 'INSERT',           icon: 'arrow-down',  available: false },
    ...
    },
    {
      ...
      items: [
        { id: 'snapshot-explorer',   label: 'Snapshot Explorer',   icon: 'camera',     available: false },
        { id: 'manifest-explorer',   label: 'Manifest Explorer',   icon: 'list',       available: false },
        { id: 'schema-evolution',    label: 'Schema Evolution',    icon: 'columns',    available: false },
        { id: 'hidden-partitioning', label: 'Hidden Partitioning', icon: 'filter',     available: false },
